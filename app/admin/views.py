...
def add_department():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            db.session.commit()
            flash('Successfully added a new spare part to Inventory.')
        except:
            # in case department name already exists
            flash('Error: Part name already exists.')
...
def edit_department(id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Successfully edited the Spare Part')
    ...
    return render_template('admin/departments/department.html', action="Edit",
                           add_department=add_department, form=form,
                           department=department, title="Edit Spare Part")
...
def delete_department(id):
    ...
    db.session.commit()
    flash('Successfully deleted the Spare Part.')

    # redirect to the departments page
    return redirect(url_for('admin.list_departments'))

    return render_template(title="Delete Spare Part")
...
def assign_employee(id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('You have successfully assigned a Inventory and Customer.')
